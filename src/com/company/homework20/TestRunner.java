...
public class TestRunner {
    ...
    public static void start(Class<Tests> testsClass) throws Exception {
        ...
        Method methodBefore = testsClass.getDeclaredMethod("methodBefore");
        ...
        Method methodAfter = testsClass.getDeclaredMethod("methodAfter");
        ...
        if (methodTest1.isAnnotationPresent(Test.class)) {
